...
GEOS performs geometric operations on vector data: intersections, buffers, unions, validity checks, and more. It works with **planar coordinates**—it treats geometries as flat 2D shapes and uses Euclidean geometry. This is fast and works well with projected coordinate systems.
