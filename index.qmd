...
Learn how to access and analyze marine biological and environmental data from [EMODnet](https://emodnet.ec.europa.eu/) using R. These hands-on tutorials guide you through real-world marine spatial analysis workflows, from accessing data via web services to creating publication-ready visualizations.
...
-   [EMODnet Biology](https://emodnet.ec.europa.eu/en/biology) - Access marine biological data
...
These tutorials are part of the [EMODnet Biology](https://emodnet.ec.europa.eu/en/biology) service. Learn more about the project, contributors, and funding on the [About](about.qmd) page.
