...
|-------------|-------------|
| [`Emodnetbio__cal_fin_*`](https://emodnet.ec.europa.eu/geonetwork/srv/eng/catalog.search#/metadata/6d617269-6e65-696e-666f-000000008220) | *Calanus finmarchicus* - key prey for gadoid larvae |
...
tmap_save(
  interactive_map,
  get_output_path("copepod_spawning_map.html", "tutorials/maps")
)

knitr::include_url("maps/copepod_spawning_map.html", height = "600px")
```
...
- **EMODnet Biology**: [emodnet.ec.europa.eu/en/biology](https://emodnet.ec.europa.eu/en/biology) for additional species distribution products
