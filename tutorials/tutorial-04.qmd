...
|----------------------|------------|-------------------------------|
| [`emodnet__mean_2022`](https://emodnet.ec.europa.eu/geonetwork/srv/eng/catalog.search#/metadata/18ff0d48-b203-4a65-94a9-5fd8b0ec35f6) | bathymetry | Mean water depth (bathymetry) |

**External Sources:**

| Source | Description |
|----------------------------|--------------------------------------------|
| [Copernicus Marine Service](https://marine.copernicus.eu/) | Bottom temperature from [MEDSEA_MULTIYEAR_PHY_006_004](https://doi.org/10.48670/mds-00375) reanalysis |
...
htmlwidgets::saveWidget(
  interactive_map,
  get_output_path("biozone_bodysize_map.html", "tutorials/maps"),
  selfcontained = TRUE
)

knitr::include_url("maps/biozone_bodysize_map.html", height = "600px")
```
...
-   [EMODnet Seabed Habitats](https://emodnet.ec.europa.eu/en/seabed-habitats): Habitat maps
-   [EMODnet Biology](https://emodnet.ec.europa.eu/en/biology): Species occurrence data
